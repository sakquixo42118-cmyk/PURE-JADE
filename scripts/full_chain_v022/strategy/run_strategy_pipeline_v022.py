...
PIPELINE_SCOPE = "research_content_2_strategy_decision_multiturn_v022"
PIPELINE_VERSION = "strategy_pipeline_v0.2.2"
...
def strategy_system_prompt_v022() -> str:
...
def strategy_user_prompt_v022(strategy_request: dict[str, Any]) -> str:
...
def api_strategy_decision_card(
    ...
    messages = [
        {"role": "system", "content": strategy_system_prompt_v022()},
        {"role": "user", "content": strategy_user_prompt_v022(strategy_request)},
    ]
