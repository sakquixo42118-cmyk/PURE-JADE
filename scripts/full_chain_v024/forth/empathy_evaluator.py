...
CHAIN_ROOT = FORTH_DIR.parent
PROJECT_ROOT = CHAIN_ROOT.parents[1]
DEFAULT_DIMENSIONS = FORTH_DIR / "evaluation_dimensions.json"
DEFAULT_CASES = FORTH_DIR / "eval-test-cases-v0.1.json"
