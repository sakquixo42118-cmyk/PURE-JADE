...
class ChatApp(ctk.CTk):
    ...
    def __init__(self):
        ...
        self._turn_id: int = 0
        self._dialogue_history: list[dict] = []  # {turn_id, speaker, content}
    ...
    def _do_chat_request(self, user_message: str):
        ...
        try:
            payload = {
                ...
                "recent_dialogue_window": self._dialogue_history,
            ...
            self._previous_snapshot = {
                "turn_id": self._turn_id,
                "dialogue_summary": sc.get("dialogue_summary") or sc.get("problem_summary", ""),
                "user_state_card": sc,
                ...
                "open_questions": sc.get("open_questions") or sc.get("unknowns", []),
            }
